<div class="card__icons">
    @if($product->favorites->count())
        @foreach($product->favorites as $pivot)
            <div class="favorite @if($pivot->pivot->product_id) favorite__active @endif" data-id="{{ $product->id }}">
    ...
    @endif
    <div class="compare" data-id="{{ $product->id }}">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg">
